///
/// The [MorseCode] class can be used to decode morse code to readable text and back.
///
class MorseCode {
  ...
  String _cipherMessage(String message, bool isMorse) {
    return message.split((isMorse) ? ' ' : '').map((letter) => _cipherLetter(letter, isMorse)).join((isMorse) ? '' : ' ');
  }
